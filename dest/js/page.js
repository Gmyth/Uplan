 ...
 */
define("page/userprofile/config", [], function(require, exports, module) {
    exports.data = {
        Profile: {
            username: "kaiyu",
            university: "university at buffalo",
 ...
 * Created by kaiyu on 11/11/16.
 */
define("page/userprofile/index", [ "lib/jquery", "page/profile/config", "util/tpl", "util/timeparser", "net/search", "util/net", "page/sublist/index", "page/sublist/config", "page/flow/index" ], function(require, exports, module) {
    var $ = require("lib/jquery");
    var config = require("page/profile/config").data;
    var tpl = require("util/tpl");
    var timeparser = require("util/timeparser");
