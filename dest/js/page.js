...
define("page/controller/module", [ "page/controller/config", "util/tpl", "lib/jquery", "widget/bootstrap", "util/util" ], function(require, exports, module) {
    ...
    /*从url获取tab信息*/
    var tmpl = {
        main: '    <h5 style="color: #FFFFFF; text-align: center">Happy &nbsp;<%=weekday%>&nbsp;,&nbsp;&nbsp;<span style="color: #FFFFFF;"><%=username%></span ></h5>    <p style="color: #FFFFFF; text-align: center"> What are we going to do today?</p>    <hr style="width: 50%; margin: auto;">    <div class="row demo-row" style="margin-top: 10px;">        <div class="col-xs-3" style="margin-left: 25%;">            <a href="#fakelink" class="btn btn-block btn-lg btn-primary" data-action="profile_open">Edit profile</a>        </div>        <div class="col-xs-3">            <a href="#fakelink" class="btn btn-block btn-lg btn-info" data-action="schedule_page">Build schedule</a>        </div>    </div>',
